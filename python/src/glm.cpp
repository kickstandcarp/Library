...
PYBIND11_PLUGIN(glm)
{
    ...
    py::class_<glm::bvec2>(m, "bvec2")
        ...
        .def("__len__", [] (const glm::bvec2 &instance) { return 2; })
    ...
    py::class_<glm::bvec3>(m, "bvec3")
        ...
        .def("__len__", [] (const glm::bvec3 &instance) { return 3; })
    ...
    py::class_<glm::bvec4>(m, "bvec4")
        ...
        .def("__len__", [] (const glm::bvec2 &instance) { return 4; })
    ...
    py::class_<glm::quat>(m, "quat")
        ...
        .def("__repr__", &to_python_string<glm::quat>);
