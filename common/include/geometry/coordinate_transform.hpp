...
class CoordinateTransform: public std::enable_shared_from_this<CoordinateTransform>
{
    public:
        ...
        const glm::mat4x4&                          get_local_matrix() const;
        const glm::mat4x4&                          get_global_matrix() const;
        const glm::mat4x4&                          get_inverse_global_matrix() const;
        ...
        glm::vec3                                   transform_position(const glm::vec3 &position, const bool to_global) const;
        glm::vec3                                   transform_direction(const glm::vec3 &direction, const bool to_global) const;
