...
const glm::mat4x4& CoordinateTransform::get_local_matrix() const
{
	const_cast<CoordinateTransform*>(this)->set_matrices();
    return this->local_matrix;
}

const glm::mat4x4& CoordinateTransform::get_global_matrix() const
{
	const_cast<CoordinateTransform*>(this)->set_matrices();
    return this->global_matrix;
}

const glm::mat4x4& CoordinateTransform::get_inverse_global_matrix() const
{
	const_cast<CoordinateTransform*>(this)->set_matrices();
...
glm::vec3 CoordinateTransform::transform_position(const glm::vec3 &position, const bool to_global) const
{
...
glm::vec3 CoordinateTransform::transform_direction(const glm::vec3 &direction, const bool to_global) const
{
